                ...
                <div className="flex flex-col h-[600px] bg-card border border-border rounded-lg">
                  ...
                  <div className="flex items-center justify-between p-4 border-b border-border">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="font-medium text-gray-200">KMRL Chakra AI</h3>
                        ...
                        <div className={`max-w-[80%] ${message.type === "user" ? "order-2" : "order-1"}`}>
                          {message.type === "assistant" && (
                            <div className="flex items-center mb-2">
                              ...
                              <span className="text-xs text-gray-400">KMRL Chakra AI</span>
                            </div>
                          )}
                          <div
                            className={`${
                            ...
                            } p-3 rounded-2xl ${message.type === "user" ? "rounded-br-md" : "rounded-bl-md"}`}
                          >
                    ...
                    <div className="relative">
                      <div className="flex items-end space-x-2 p-3 border border-border rounded-2xl bg-gray-800 focus-within:border-primary transition-colors">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className={`text-gray-400 hover:text-gray-200 p-2 ${isRecording ? "text-red-400" : ""}`}
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Chat with our AI for personalized help and file attachments</p>
                  </div>
                  <div>
                    <p className="font-medium text-gray-200">Voice Search</p>
                    <p className="text-gray-400">Use voice commands for hands-free searching</p>
                  </div>
                </div>
              </CardContent>
            </Card>
