      ...
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="space-y-4 text-center">
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-gradient-metro">
            <Image src="/kmrl-logo.jpg" alt="KMRL Logo" width={60} height={60} className="rounded-full" />
          </div>
          <div>
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button type="submit" className="w-full bg-gradient-metro hover:opacity-90" disabled={isLoading}>
