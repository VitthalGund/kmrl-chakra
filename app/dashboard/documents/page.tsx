      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage and access KMRL documents</p>
          </div>
              ...
              <form onSubmit={handleUpload} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setUploadData({ ...uploadData, access_roles: value })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <Button type="submit" className="w-full bg-gradient-metro hover:opacity-90" disabled={isUploading}>
